package com.epam.agency.config.application;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = {"com.epam.agency.config", "com.epam.agency.controller", "com.epam.agency.service"})
public class WebConfig extends WebMvcConfigurerAdapter {
    ...
    public ReloadableResourceBundleMessageSource messageSource() {
        ...
        source.setBasename("classpath:/locale");
