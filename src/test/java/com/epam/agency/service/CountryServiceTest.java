...
import com.epam.agency.service.impl.CountryService;
...
public class CountryServiceTest {
    ...
    public void testFinCountryById() {
        when(countryRepository.findById(0)).thenReturn(country);
        Country country = countryService.findById(0);
        verify(countryRepository).findById(0);
